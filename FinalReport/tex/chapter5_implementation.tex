...
\begin{figure}[ht]
	...
	\caption{The Green and Red Arrow holograms rendered. The number under the arrow is the associated tracker ID of the object. This allows us to track objects in the surroundings.}
	\label{fig:holograms}
\end{figure}
