...
\subsubsection{Hololens World Manager}
...
We need to represent the powered wheelchair in the Unity application so that we can calculate the distance between the detected objects and ARTA. As such, the ARTA manager subscribes to the topics published by ARTA.
